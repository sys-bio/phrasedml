...
%feature("docstring") getLastSEDML "
 ...
 converts that representation to SEDML and returns the value,
...
Parameter 'filename' is The string that, when used in phrasedml,
 should reference the 'doc'. Parameter 'doc' is The SBML Document to
 use when the 'filename' is encountered.
...
%feature("docstring") freeAll "
 ...
 anything, as long as you call 'freeAll' at the very end of your
